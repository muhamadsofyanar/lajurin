...
export default async function sitemap(): Promise<MetadataRoute.Sitemap> {
  ...
  return [{ url: base, changeFrequency: "weekly", priority: 1 }, { url: `${base}/marketplace`, changeFrequency: "daily", priority: 0.9 }, { url: `${base}/filosofi`, changeFrequency: "monthly", priority: 0.7 }, ...rows.map((row) => ({ url: `${base}/p/${row.slug}`, lastModified: row.updatedAt, changeFrequency: "weekly" as const, priority: 0.8 }))];
}
