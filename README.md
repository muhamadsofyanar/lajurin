...
> Status: alpha platform kernel. Source mempertahankan seluruh kapabilitas v4.0.1 dan menambahkan transactional outbox, worker, correlation context, policy engine, serta observability dasar. Lihat `RELEASE_v5.0.0-alpha.1.md` dan `docs/implementation/V5_PHASE_0_1_STATUS.md`.
